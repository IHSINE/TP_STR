 ...
 * Automatically generated by goil on Tue Feb  9 09:40:33 2016
...
/* Alarm aT3 identifier */
#define aT3_id 2
CONST(AlarmType, AUTOMATIC) aT3 = aT3_id;
...
CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE = 4000;
...
CONST(tpl_task_activation_action, OS_CONST) aT3_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  task2_id
...
CONST(tpl_alarm_static, OS_CONST) aT3_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , aT3_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&aT3_action
};
...
VAR(tpl_time_obj, OS_VAR) aT3_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&aT3_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  2000,
    /* date                         */  100,
...
VAR(tpl_proc_id, OS_VAR) tpl_priority_1_fifo[4];
